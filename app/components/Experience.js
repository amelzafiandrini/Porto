        ...
        {projects.map((p, i) => (
          ...
          >
            ...
            >
              ...
              {/* Label jumlah foto (khusus yg punya lebih dari 1 gambar) */}
        ...
        {preview && (
          ...
          >
            <motion.div
              ...
              className="relative max-w-5xl w-full flex gap-4 justify-center"
            >
              {/* Foto dalam modal */}
              {(preview.images ? preview.images : [preview.image]).map(
                (img, idx) => (
                  <img
                    ...
                    className={`${
                      preview.images ? "w-1/2" : "w-full"
                    } rounded-2xl border border-white/20 shadow-xl shadow-pink-400/20 object-contain`}
                  />
                )
              )}
